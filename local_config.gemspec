...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/local_config.rb", "test/local_config_test.rb", "test/test_helper.rb", "test/test_rails_root", "test/test_rails_root/config", "test/test_rails_root/config/no_env.yml", "test/test_rails_root/config/with_local.local.yml", "test/test_rails_root/config/with_local.yml", "test/test_rails_root/config/without_local.yml", "LICENSE"]
  s.has_rdoc = true
